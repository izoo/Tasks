                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-13.jpg')}}" alt="avatar"><span>Luke Ivory</span></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-7.jpg')}}" alt="avatar"><span>Andy King</span></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-10.jpg')}}" alt="avatar"><span>Laurie Fox</span></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-5.jpg')}}" alt="avatar"><span>Ryan Collins</span></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-4.jpg')}}" alt="avatar"><span>Irene Collins</span></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-11.jpg')}}" alt="avatar"><span>Sonia Shaw</span></div></td>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table table-scroll">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('backend/assets/img/product-headphones.jpg')}}" alt="product"><div class="align-self-center"><p class="prd-name">Headphone</p><p class="prd-category text-primary">Digital</p></div></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('backend/assets/img/product-shoes.jpg')}}" alt="product"><div class="align-self-center"><p class="prd-name">Shoes</p><p class="prd-category text-warning">Faishon</p></div></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('backend/assets/img/product-watch.jpg')}}" alt="product"><div class="align-self-center"><p class="prd-name">Watch</p><p class="prd-category text-danger">Accessories</p></div></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('backend/assets/img/product-laptop.jpg')}}" alt="product"><div class="align-self-center"><p class="prd-name">Laptop</p><p class="prd-category text-primary">Digital</p></div></div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{asset('backend/assets/img/product-camera.jpg')}}" alt="product"><div class="align-self-center"><p class="prd-name">Camera</p><p class="prd-category text-primary">Digital</p></div></div></td>
